...
const Projects = () => {
  ...
  return (
    <section 
      ...
      id="projects"
     >
      <div className="mx-auto flex w-[100%] flex-row lg:flex-row lg:gap-20 relative z-10 w-full flex items-center justify-center overflow-hidden bg-[#000000] bg-center pt-16 pb-36 md:pt-20 md:pb-44 lg:pt-20 lg:pb-56" id="greetings h-[100%]">
