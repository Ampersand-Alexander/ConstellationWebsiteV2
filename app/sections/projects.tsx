...
const Projects = () => {
  ...
  return (
    <section className="relative w-full items-center justify-center overflow-hidden pt-16 pb-36 md:pt-20 md:pb-44 lg:pt-30 lg:pb-56" id="projects" style={{ backdropFilter: 'blur(5px)'}}>
      <div className="absolute top-0 left-0 mx-auto flex w-[100%] flex-col lg:gap-10 relative z-10 w-full flex items-center justify-left overflow-hidden bg-[#000000] bg-center pt-16 pb-20 md:pt-20 md:pb-44 lg:pt-20 lg:pb-56 h-[100%]">
        {projectCards.map((project, index) => (
          <Link href={project.link} key={index} target="_blank" rel="noopener noreferrer">
            ...
            <div className="project-card text-white rounded-lg p-6 w-full lg:w-200 h-200 border-2 border-customGrey relative opacity-50%" style={{ backgroundImage: `url(${project.background})`, backgroundSize: 'cover' }}>
